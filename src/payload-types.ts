...
export interface Tenant {
  id: string;
  /**
   * This will be the name of the store (e.g. John's store)
   */
  name: string;
  /**
  ...
  /**
   * You cannot create products until you have set up your stripe details
   */
...
export interface Order {
  ...
  /**
   * Stripe accoount associated with the order
   */
